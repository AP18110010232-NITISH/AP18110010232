package com.Nitish.handwashreminder.receivers;
...
import com.Nitish.handwashreminder.R;
import com.Nitish.handwashreminder.views.MainActivity;
    ...
    private void setUpNotification(Context context) {
        ...
        if (Build.VERSION.SDK_INT >=
            ...
            notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_REMINDER
                    , "Hand washing", NotificationManager.IMPORTANCE_HIGH);

            notificationChannel.setLightColor(Color.RED);
            notificationChannel.enableLights(true);
            notificationChannel.enableVibration(true);
            notificationChannel.setDescription("Recall hand washing or disinfection");
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, NOTIFICATION_CHANNEL_REMINDER)
                .setContentTitle("Do not forget to wash your hands!")
