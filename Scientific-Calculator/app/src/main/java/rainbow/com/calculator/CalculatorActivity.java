...
public class CalculatorActivity extends AppCompatActivity {
    ...
    Button zero,one,two,three,four,five,six,seven,eight,nine,add,sub,mul,div,mod,equal,clear,del,point,sin,cos,tan,log,ln,sqrt,square,pow,hide, sinh,cosh,tanh;
    String operation;
    double value;
    double valueone;
    double result;
